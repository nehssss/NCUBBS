package com.haitaos.finallbbs.provider;
...
import com.haitaos.finallbbs.cache.TinifyPngCache;
...
import com.haitaos.finallbbs.utils.RandomUtils;
...
//        }
    ...
    public String  upload(InputStream fileStream, String contentType, String fileName , Long contentLength) {
      ...
      /*  if("image/png".equals(contentType)&&tinifyEnable==1&&contentLength>tinifyMinContentLength){//进行图片质量压缩（png），若不处理请忽略
        ...
        String initUrl = uploadtoBucket(fileStream,"zip",contentType,fileName,contentLength);
        return initUrl;
    }
    ...
    public String uploadtoBucket(InputStream inputStream, String fileType, String contentType,  String fileName, Long contentLength){
        ...
        String key = "/upload/project/"+System.currentTimeMillis()+"/"+fileType+"/"+fileName;
