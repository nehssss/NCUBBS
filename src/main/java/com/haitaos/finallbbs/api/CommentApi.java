...
import com.haitaos.finallbbs.constant.PageConstant;
import com.haitaos.finallbbs.dto.CommentDTO;
...
import com.haitaos.finallbbs.vo.CommentInsertVO;
...
public class CommentApi {
    ...
    public Object insert(@RequestBody @Valid CommentInsertVO commentInsertVO,//@RequestBody接受json格式的数据
        ...
        System.out.println("comment"+commentInsertVO.getToken());
        System.out.println("IP"+ipLimitCache.getInterval(commentInsertVO.getIp()));
        System.out.println(commentInsertVO.getToken().equals(ipLimitCache.getInterval(commentInsertVO.getIp())));
