...
layui.define(['form'], function (exports) {
    ...
    var verifyList = {
        ...
        repeat:function(h,g){if(h!=d(d(g).data("target")).val()){var f=d(g).data("tips");return f?f:"两次输入不一致"}},
        /* 整数 */
        ...
        /* 字母和数字 */
        letterAndDigital: function (value, item) {
            var reg = /^[a-zA-Z0-9]+$/;
            if (value && !reg.test(value)) {
                return verifyText.letterAndDigital;
            }
        }
    };
