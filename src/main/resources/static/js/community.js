...
//do whatever here..
                    ...
                    sweetAlert("错误："+response.code, response.message, "error").then(function () {
                        location.reload();
                    })
                    // window.location.reload();
        ...
        error:function(XMLHttpRequest, textStatus, errorThrown){
            swal(textStatus, "错误："+XMLHttpRequest.status, "error").then(function () {
               location.reload();
            })
            //window.location.reload();
        },
...
function like_comment(e) {
    ...
    console.log(thumbicon.attr('class').indexOf('zanok'));
    if(thumbicon.attr('class').indexOf('zanok')!=-1){
        console.log(thumbicon.attr('class'));
        swal({
            title: "点赞失败!",
            text: "请不要重复点赞哦!",
            icon: "error",
